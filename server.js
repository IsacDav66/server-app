...
const assetlinksContent = [
    {
        ...
        "target": {
            ...
            "package_name": "com.omletwebfinal",
...
// 2. Ruta para la raíz (Si Servequake lo permite)
app.get('/.well-known/assetlinks.json', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.json(assetlinksContent);
});

// 3. Ruta con prefijo /app (Por si el proxy te obliga a usarlo)
app.get('/app/.well-known/assetlinks.json', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.json(assetlinksContent);
});
const PORT = 3001;
    ...
    socket.on('send_message', async (data) => {
        ...
        try {
            ...
            try {
                ...
                console.error("❌ Error en Push:", pushErr.message);
            }
